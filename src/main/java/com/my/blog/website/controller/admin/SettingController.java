...
public class SettingController extends BaseController {
    ...
    public RestResponseBo saveSetting(@RequestParam(required = false) String site_theme, HttpServletRequest request){
        try {
            ...
            if (StringUtils.isNoneBlank(site_theme)){
                BaseController.THEME = "themes" + site_theme;
            }
            logService.insertLog(LogActions.SYS_SETTING.getAction() , GsonUtils.toJsonString(queries), request.getRemoteAddr(), this.getUid(request));
