...
import com.my.blog.website.controller.IndexController;
...
public class PageController extends BaseController {
    ...
    public String index(HttpServletRequest request){
        ...
        PageInfo<ContentVo> contentPaginator = contentService.getArticlesWithPage(contentVoExample , 1 , WebConst.MAX_POSTS);
        request.setAttribute("articles",contentPaginator);
    ...
    public String editPage(String cid, HttpServletRequest request){
