...
public final class Commons {
    ...
    public static String show_categories(String categories) throws UnsupportedEncodingException{
        if (StringUtils.isNotBlank(categories)){
            ...
            for (String c : arr){
                stringBuffer.append("<a href=\"/category/" + URLEncoder.encode(c,"UTF-8") + "\">" + c + "</a>");
            }
    ...
    public static String show_tags(String tags) throws UnsupportedEncodingException{
        if (StringUtils.isNotBlank(tags)){
            ...
            StringBuffer stringBuffer = new StringBuffer();
            for (String c : arr){
                stringBuffer.append("<a href=\"/tag/" + URLEncoder.encode(c,"UTF-8") + "\">" + c + "</a>");
            }
            return stringBuffer.toString();
        }
        return "";
    ...
    public static List<MetaDto> categories(){
        return categories(WebConst.MAX_POSTS);
    }
